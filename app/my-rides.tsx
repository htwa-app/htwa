...
/** Status badge colours — booking status colours not in §1 palette */
const STATUS_COLORS: Record<string, { bg: string; text: string }> = {
  active:    { bg: Colors.primaryLight, text: Colors.primary },
  confirmed: { bg: '#E8F8EE',           text: '#1A7A3C' },
  pending:   { bg: Colors.amberLight,   text: '#8B5A00' },
  cancelled: { bg: Colors.border,       text: Colors.textSecondary },
  full:      { bg: Colors.amberLight,   text: '#8B5A00' },
